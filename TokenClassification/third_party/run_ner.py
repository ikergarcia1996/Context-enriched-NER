...
def main():
    ...
    def get_label_list(labels):
        ...
        if "B-ORG" in label_list:  # ADD MISC FOR EVAL IT AND MSRA
            if not "B-MISC" in label_list:
                label_list.append("B-MISC")
            if not "I-MISC" in label_list:
                label_list.append("I-MISC")
        if "L-ORG" in label_list or "L-PER" in label_list or "L-LOC" in label_list:
            if not "L-MISC" in label_list:
                label_list.append("L-MISC")
            if not "U-MISC" in label_list:
                label_list.append("U-MISC")
